...
class SettingsForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'logo': forms.FileInput(attrs={'class': 'form-control-file custom-file-input',}),
            'favicon': forms.FileInput(attrs={'class': 'form-control-file custom-file-input',}),
            'fb_link': forms.TextInput(attrs={'class': 'form-control','placeholder':'https://'}),
            'insta_link': forms.TextInput(attrs={'class': 'form-control','placeholder':'https://'}),
            'twiter_link': forms.TextInput(attrs={'class': 'form-control','placeholder':'https://'}),
            'linkedin_link': forms.TextInput(attrs={'class': 'form-control','placeholder':'https://'}),
            'pinterest_link': forms.TextInput(attrs={'class': 'form-control','placeholder':'https://'}),
